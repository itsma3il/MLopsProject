...
\begin{itemize}
    \item \repoPath{tests/test_data_contract.py}: validation du contrat de données;
    \item \repoPath{tests/test_dataset_loader.py}: comportement du loader dataset;
    \item \repoPath{tests/test_api.py}: preprocessing, feature engineering, endpoints API, métriques et erreurs attendues.
\end{itemize}
