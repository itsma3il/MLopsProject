...
Le dépôt fournit une documentation Agile dans \repoPath{fraud-detection/docs/agile.md}. Elle définit les rôles attendus, le product backlog, les user stories et un déroulement en trois sprints. Les noms réels des membres de l'équipe restent à compléter dans le document source.
