...
Le pipeline d'ingestion est implémenté dans \repoPath{src/core/data/ingestion.py}. Il charge le fichier Kaggle, applique le contrat via \repoPath{assert_creditcard_contract}, puis exécute un pipeline dlt vers DuckDB.
